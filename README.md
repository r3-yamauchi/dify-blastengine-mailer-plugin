...
Tests rely on lightweight stubs for both `dify_plugin` and the Blastengine SDK, so no network or credentials are required.

## License

MIT License — full text in `LICENSE`. Source will live at [github.com/r3-yamauchi/dify-blastengine-mailer-plugin](https://github.com/r3-yamauchi/dify-blastengine-mailer-plugin).
